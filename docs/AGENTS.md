...
```bash
undercroft verify           # eight legs: HMAC every record, replay the audit
                           ...
                           # retention row to its chain record; exit 2 on failure
