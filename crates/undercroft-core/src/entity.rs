...
const STOPWORDS: &[&str] = &[
    "the", "this", "that", "these", "those", "a", "an", "i", "we", "you", "he", "she", "it",
    "they", "my", "our", "your", "their", "if", "when", "then", "and", "or", "but", "so",
    "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "january",
    "february", "march", "april", "may", "june", "july", "august", "september", "october",
    "november", "december", "today", "tomorrow", "yesterday", "ok", "yes", "no", "hi", "hello",
];
