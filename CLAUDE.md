...
```bash
docker compose run --rm test          # cargo unit + integration tests (769 run,
                                      # 4 #[ignore]d = 773 compiled. Counted from
...
docker compose run --rm e2e           # e2e UI/UX suite against the release binary (388 checks)
