...
```bash
docker compose run --rm test          # cargo unit + integration tests (698 run,
                                      # 4 #[ignore]d = 702 compiled. Counted from
...
docker compose run --rm e2e           # e2e UI/UX suite against the release binary (316 checks)
